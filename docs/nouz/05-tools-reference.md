...
<div class="lab-bridge">
  ...
  <p>После справочника можно перейти от API к наблюдаемому пространству: лаборатория показывает, почему эталоны, centered scoring и поиск по чанкам важно проверять на реальных embedding-моделях.</p>
