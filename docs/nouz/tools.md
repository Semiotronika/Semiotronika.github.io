...
Инструменты — это основной интерфейс NOUZ. Через них AI-агент читает файлы вместе со структурой базы: видит узлы, связи, уровни, домены, кандидатов на мосты и сигналы дрифта.
